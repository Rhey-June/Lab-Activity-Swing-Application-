...
public class MainFrame extends javax.swing.JFrame {
    ...
    private final StudentCsvRepository  repository = new StudentCsvRepository();
    ...
    private void initComponents() {
        ...
        btnReload.setText("Reload from CSV");
 ...
 private void addStudent() {
        ...
        Student s  = new Student(nextId++, name, course.trim(), email, now, now);
    ...
    private void refreshTableFromList() {
        ...
        for (Student s : students) {
            model.addRow(new Object[]{
                ...
                s.getCourse(),
                s.getEmail(),
                s.getDateCreated().format(FORMATTER),
                s.getDateUpdated().format(FORMATTER)
            });
        }
    }
    private void setNextId() {
     ...
     private boolean validateInput(String name, String course, String email) {
        ...
        if (!email.isEmpty() && (!email.contains("@") || !email.contains("."))) {
            JOptionPane.showMessageDialog(this,
                    "Email must contain '@' and '.' (e.g. student@email.com).",
                    "Validation Error",
                    JOptionPane.ERROR_MESSAGE);
            return false;
        }
